...
large_checkpoint_directory = 'experiments/checkpoints/gaf-resnet-large/state_dict_model.pt'
small_checkpoint_directory_finetuned = 'experiments/checkpoints/gaf-resnet-small-finetuned/state_dict_model.pt'
small_checkpoint_directory = 'experiments/checkpoints/gaf-resnet-small/state_dict_model.pt'
...
def main():
    ...
    predictions_df.to_csv('experiments/results/gaf-resnet/resnet_large_predictions.csv', index=False)
   ...
   # Load Small Dataset
    ...
    print('\n#--- Predict ResNet50-Small-Finetuned ---\n')
    ...
    predictions_df.to_csv('experiments/results/gaf-resnet/resnet_small_finetuned_predictions.csv', index=False)

    print('\n#--- Predict ResNet50-Small-No-Finetuned ---\n')
    ...
    predictions_df.to_csv('experiments/results/gaf-resnet/resnet_small_no_finetuned_predictions.csv', index=False)
