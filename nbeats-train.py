...
from models.darts.nbeats import NBEATS
...
large_work_dir = 'experiments/checkpoints/nbeats'
large_model_name = 'large'
large_tensorboard_dir = 'experiments/tensorboard/nbeats/large'
small_finetuned_work_dir = 'experiments/checkpoints/nbeats'
small_finetuned_model_name = 'small-finetuned'
small_finetuned_tensorboard_dir = 'experiments/tensorboard/nbeats/small-finetuned'
small_work_dir = 'experiments/checkpoints/nbeats'
small_model_name = 'small'
small_tensorboard_dir = 'experiments/tensorboard/nbeats/small'
device_id = 0
seed = 0
...
def main():
    ...
    # Train NBEATS-Large model
    print('\n#--- Training NBEATS-Large ---\n')
    ...
    evaluation_df.to_csv('experiments/results/nbeats/large_evaluation.csv', index=False)

    print('\n#--- Predicting Time Series using NBEATS-Large ---\n')
    ...
    predictions_df.to_csv('experiments/results/nbeats/large_predictions.csv', index=False)
    ...
    # Train NBEATS-Small-Finetuned
    print('\n#--- Training NBEATS-Small-Finetuned ---\n')
    ...
    evaluation_df.to_csv('experiments/results/nbeats/small_finetuned_evaluation.csv', index=False)

    print('\n#--- Predicting Time Series using NBEATS-Small-Finetuned ---\n')
    ...
    predictions_df.to_csv('experiments/results/nbeats/small_finetuned_predictions.csv', index=False)

    print('\n#--- Training NBEATS-Small-No-Finetuned ---\n')
    ...
    evaluation_df.to_csv('experiments/results/nbeats/nbeats_small_evaluation.csv', index=False)

    print('\n#--- Predicting Time Series using NBEATS-Small-No-Finetuned ---\n')
    ...
    predictions_df.to_csv('experiments/results/nbeats/small_predictions.csv', index=False)
