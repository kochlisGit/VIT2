...
from models.darts.nhits import NHITS
...
large_work_dir = 'experiments/checkpoints/nhits'
large_model_name = 'large'
large_tensorboard_dir = 'experiments/tensorboard/nhits/large'
small_finetuned_work_dir = 'experiments/checkpoints/nhits'
small_finetuned_model_name = 'small-finetuned'
small_finetuned_tensorboard_dir = 'experiments/tensorboard/nhits/small-finetuned'
small_work_dir = 'experiments/checkpoints/nhits'
small_model_name = 'small'
small_tensorboard_dir = 'experiments/tensorboard/nhits/small'
device_id = 0
seed = 0
...
def main():
    ...
    # Train NHITS-Large model
    print('\n#--- Training NHITS-Large ---\n')
    ...
    evaluation_df.to_csv('experiments/results/nhits/large_evaluation.csv', index=False)
    ...
    predictions_df.to_csv('experiments/results/nhits/large_predictions.csv', index=False)
    ...
    # Train nhits-Small-Finetuned
    print('\n#--- Training NHITS-Small-Finetuned ---\n')
    ...
    evaluation_df.to_csv('experiments/results/nhits/small_finetuned_evaluation.csv', index=False)
    ...
    predictions_df.to_csv('experiments/results/nhits/small_finetuned_predictions.csv', index=False)

    print('\n#--- Training NHITS-Small-No-Finetuned ---\n')
    ...
    evaluation_df.to_csv('experiments/results/nhits/small_evaluation.csv', index=False)

    print('\n#--- Predicting Time Series using NHits-Small-No-Finetuned ---\n')
    ...
    predictions_df.to_csv('experiments/results/nhits/small_predictions.csv', index=False)
